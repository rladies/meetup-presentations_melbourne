...
library(png)
library(grid)
img <- readPNG("~/Documents/personal/Rladies/logo/logo.png")
grid.raster(img)
```
...
Prepared and presented by [Melina Vidoni](https://melvidoni.rbind.io/)

## [NLP with SpaCy in R](https://github.com/R-LadiesMelbourne/2019-06-18-NLP-with-SpaCy-in-R)

Prepared and presented by [Ana Mamatelashvili](shttps://github.com/anamamatelashvili)
